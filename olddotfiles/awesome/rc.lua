...
local theme_path=string.format("%s/.config/awesome/themes/%s/theme.lua", os.getenv("HOME"), "cards")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "uno", "dos", "tres", "cuatro", "cinco", "seis" }, s, awful.layout.layouts[1])
	--for i=1,5 do
	--	awful.tag.incgap(5,s.tags[i])
	--end
    ...
    s.mylay = wibox.container.margin(s.mylayoutbox, dpi(0), dpi(5), dpi(8), dpi(8))
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            wibox.container.margin(fs_widget(), dpi(0), dpi(2), dpi(7), dpi(7)),
            volume_widget(),
            battery_widget(),
        },
    }
...
awful.rules.rules = {
    ...
    { rule_any = {
        ...
        -- and the name shdwn there might not match defined rules here.
        name = {
          "Event Tester",  -- xev.
        },
        role = {
